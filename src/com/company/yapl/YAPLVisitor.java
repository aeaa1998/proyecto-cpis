...
public interface YAPLVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link YAPLParser#declaration_with_possible_assignation}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDeclaration_with_possible_assignation(YAPLParser.Declaration_with_possible_assignationContext ctx);
	/**
